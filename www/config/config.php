...
define('URL_BASE', 'http://' . $_SERVER["HTTP_HOST"].'/metodoagora/mjailton/borrao/materiais_curso/nfe/');
define('URL_IMAGEM', "http://". $_SERVER['HTTP_HOST'] . "/estrutura_mvc/UP/");

define('URL_XML', "http://". $_SERVER['HTTP_HOST'] . "/metodoagora/mjailton/borrao/nfe/");
