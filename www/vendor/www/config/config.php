...
define('URL_BASE', 'http://' . $_SERVER["HTTP_HOST"].'/metodoagora/mjailton/cursos/projeto_nfe/campos-nfe/');
define('URL_IMAGEM', "http://". $_SERVER['HTTP_HOST'] . "/estrutura_mvc/UP/");

define('URL_XML', "http://". $_SERVER['HTTP_HOST'] . "/metodoagora/mjailton/cursos/projeto_nfe/campos-nfe/");
